...
class ColorPalette:
    def __init__(self):
        ...
        label_color = tp.Text("COLOR PALETTE", font_size=12)
        ...
        self.palette = tp.Group([self.color_preview, self.picker_predef], "h", gap=5)
        self.group_color = tp.Group([label_color, self.palette], "v", gap=2)
